        ...
        },
        {
            ...
            children: [{
                ...
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "form" */ '../components/page/clinical_pathway/ClinicalPathway.vue'),
                    meta: {
                        title: '临床路径'
                    }
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "form" */ '../components/page/clinical_pathway_setting/ClinicalPathwaySetting.vue'),
                    meta: {
                        title: '临床路径设置'
                    }
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "form" */ '../components/page/template_maintenance/TemplateMaintenance.vue'),
                    meta: {
                        title: '模版维护'
                    }
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "form" */ '../components/page/medical_database/MedicalDatabases.vue'),
                    meta: {
                        title: '医学资料库'
                    }
                },
                ...
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "tabs" */ '../components/page/inpatient_medical_workstation/InpatientMedicalWorkstation.vue'),
                    meta: {
                        title: '住院医护工作站'
                    }
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "form" */ '../components/page/hospital_consultation/HospitalConsultationWorkstation.vue'),
                    meta: {
                        title: '院内会诊工作站'
                    }
                },
                ...
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "dragdialog" */ '../components/page/hospital_medical_record_quality_control/MedicalRecordQualityControlWorkstation.vue'),
                    meta: {
                        title: '病例质控工作站'
                    }
                },
                ...
                },
                {
                    ...
                    component: () =>
                        import ( /* webpackChunkName: "donate" */ '../components/page/system_maintenance/SystemMaintenance.vue'),
                    meta: {
                        title: '系统维护'
                    }
                },
